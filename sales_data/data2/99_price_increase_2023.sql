...
--
--   Orders from 2019-2022 keep pointing at the OLD product_key and so
...
--   Type 1 the price would be overwritten and four years of history
--   would silently change value.
--
--   data2 was generated with these new prices already applied from
