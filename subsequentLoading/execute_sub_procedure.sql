...
--   EXEC load_order_fact_incremental(DATE '2023-01-02'); <- backfill window
--
-- ===================================================================
...
-- DATE '2023-01-02' resolves to "from 2023-01-01 onward". The window
-- has no upper bound, so one call backfills all of data2.
--
...
EXEC load_br_exp_fact_incremental(DATE '2023-01-02');
